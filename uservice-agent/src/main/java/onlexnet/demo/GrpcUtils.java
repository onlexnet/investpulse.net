...
/**
 * Some static helper methods around gRpc. Candidate to be moved to shared
 * library.
 */
@UtilityClass
public class GrpcUtils {
    ...
    /**
     * gRpc interceptor to add to each incoming call header with given
     * {@code targetDaprApplicationId}.
     */
